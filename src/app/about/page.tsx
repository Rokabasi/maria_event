                    ...
                    <AnimatedSection animation="fade-up" delay={600}>
                        <div className="mt-8 text-center">
                            <button
                                ...
                                className="inline-flex items-center gap-2 bg-black text-white px-8 py-4 rounded-full font-semibold hover:bg-gray-800 transition-all duration-200 transform hover:scale-105 shadow-lg"
                            >
                                <svg
                                ...
                                Recommandez-nous à vos proches
                            </button>
                        </div>
                    </AnimatedSection>
                </div>

                    ...
                    <AnimatedSection animation="fade-scale">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <button
                                ...
                                className="bg-black text-white px-6 py-2.5 rounded-full hover:bg-gray-800 transition-all duration-200 text-sm transform hover:scale-105"
                            >
            ...
            <section className="py-6 px-4 flex-1">
                <div className="max-w-xl mx-auto">
                    ...
                    >
                        {cart.map((item) => (
                            <div key={`${item.id}-${item.size}`} className="bg-white rounded-2xl p-3 flex items-start gap-3 relative">
                                ...
                                <button onClick={() => removeFromCart(item.id, item.size)} className="text-red-500 hover:text-red-600 absolute top-3 right-3 transition-all duration-200 hover:scale-110">
                                ...
                                <div className="absolute bottom-3 right-3">
                                    <div className="flex items-center gap-2 bg-gray-100 rounded-full px-3 py-1">
                                        <button onClick={() => updateQuantity(item.id, item.size, item.quantity - 1)} className="text-gray-600 hover:text-black text-sm font-bold transition-colors">-</button>
                    ...
                    <AnimatedSection animation="fade-up" delay={400}>
                        <button onClick={handleWhatsAppOrder} className="w-full bg-black text-white py-3 rounded-full hover:bg-gray-800 transition-all duration-200 font-semibold flex items-center justify-center gap-2 text-sm transform hover:scale-105">
                    ...
                    <AnimatedSection animation="fade-right" delay={500}>
                        <div className="flex gap-2.5 mt-3">
                            <button onClick={() => router.push('/products')} className="flex-1 bg-white text-black py-2 rounded-full hover:bg-gray-100 transition-all duration-200 font-medium border border-gray-200 text-sm transform hover:scale-105">
                                Continuer
                            </button>
                            <button onClick={clearCart} className="flex-1 bg-white text-red-500 py-2 rounded-full hover:bg-red-50 transition-all duration-200 font-medium border border-red-200 text-sm transform hover:scale-105">
                                Vider
                            </button>
                        </div>
                    </AnimatedSection>
